...
const STRINGS = {
  vi: {
    ...
    'filter.preset.today': 'Hôm nay',
    'filter.preset.yesterday': 'Hôm qua',
    'filter.preset.7d': '7 ngày qua',
    'filter.preset.14d': '14 ngày qua',
    'filter.preset.30d': '30 ngày qua',
    'filter.preset.90d': '90 ngày qua',
    'filter.preset.thisMonth': 'Tháng này',
    'filter.preset.lastMonth': 'Tháng trước',
    'picker.placeholder': 'Chọn khoảng ngày',
    'picker.apply': 'Áp dụng',
    'picker.clear': 'Đặt lại',
    'picker.pickStart': 'Chọn ngày bắt đầu',
    'picker.pickEnd': 'Chọn ngày kết thúc',
  ...
  en: {
    ...
    'filter.preset.7d': 'Last 7 days',
    'filter.preset.14d': 'Last 14 days',
    'filter.preset.30d': 'Last 30 days',
    'filter.preset.90d': 'Last 90 days',
    'filter.preset.thisMonth': 'This month',
    'filter.preset.lastMonth': 'Last month',
    'picker.placeholder': 'Pick a date range',
    'picker.apply': 'Apply',
    'picker.clear': 'Clear',
    'picker.pickStart': 'Pick a start date',
    'picker.pickEnd': 'Pick an end date',
